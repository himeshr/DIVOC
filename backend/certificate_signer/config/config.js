...
const RABBITMQ_SERVER = process.env.RABBITMQ_SERVER || 'amqp://guest:guest@localhost:5672/';
...
const COMMUNICATION_MODE = process.env.COMMUNICATION_MODE || COMMUNICATION_MODE_KAFKA;
